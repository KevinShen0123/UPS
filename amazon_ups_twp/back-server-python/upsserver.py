...
def connect_world_socket():
    world_host = 'vcm-34854.vm.duke.edu'
...
def connect_to_database():
    connect=psycopg2.connect(host="localhost",database="mini_ups",user="postgres",password="20230101")
    # connect.close()
    return connect
def create_database(connect):
    ...
    connect.commit()
amazon_ip="vcm-34854.vm.duke.edu" #可以随时更改
